  ...
  const [categories, setCategories] = useState<Category[]>([
    {
      ...
      styles_en: ['Professional', 'Business Casual', 'Executive', 'Formal Meeting'],
    ...
    },
    {
      ...
      styles_en: ['Artistic', 'Bohemian', 'Vintage', 'Modern Art'],
      image_url: '/images/ornek.jpg',
      is_active: true,
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString()
    },
    {
      ...
      styles_en: ['Cartoon', 'Realistic', 'Anime', 'Fantasy'],
      image_url: '/images/ornek.jpg',
      is_active: true,
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString()
    },
    {
      ...
      styles_en: ['Casual', 'Formal', 'Sporty', 'Trendy'],
      image_url: '/images/ornek.jpg',
      is_active: true,
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString()
    },
    {
      ...
      styles_en: ['Office', 'Studio', 'Nature', 'Abstract'],
      image_url: '/images/ornek.jpg',
      is_active: true,
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString()
    },
    {
      ...
      styles_en: ['Natural', 'Glowing', 'Professional', 'Fresh'],
      image_url: '/images/ornek.jpg',
      is_active: true,
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString()
